...
# RUN R -e "require(devtools); install_version('latticeExtra', version = '0.6-28', dependencies= T, repos='http://cran.us.r-project.org')"
# RUN R -e "require(devtools); install_version('ggplot2', version = '3.2.1', dependencies= T, repos='http://cran.us.r-project.org')"
